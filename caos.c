...
int main(void){
    ...
    // LINHA DE ATRASO T1
    // ===============================
    GENLIB_LOINS("inv_x1", "inv_t1_0", "fback_raw", "node_t1_1", "vdd", "vss", NULL);
    ...
    // LINHA DE ATRASO T2
    // ===============================
    GENLIB_LOINS("inv_x1", "inv_t2_0", "fback_raw", "node_t2_1", "vdd", "vss", NULL);
    ...
    // LINHA DE ATRASO T3
    // ===============================
    GENLIB_LOINS("inv_x1", "inv_t3_0", "fback_raw", "node_t3_1", "vdd", "vss", NULL);
    ...
    // XOR2: A ⊕ T1 → fback_raw_raw
    GENLIB_LOINS("xr2_x1", "xor2", "A", "i_n1", "fback_raw_raw", "vdd", "vss", NULL);

    // ===============================
    // SAÍDA
    // ===============================
    GENLIB_LOINS("inv_x1", "buf_s", "fback_raw", "S", "vdd", "vss", NULL);
